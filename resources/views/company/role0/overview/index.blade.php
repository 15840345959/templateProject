            ...
            <div class="layui-col-sm6 layui-col-md3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layuiadmin-card-list">
                        ...
                        <p>
                            项目数
                            <span class="layuiadmin-span-color">{{$page_data['total_bus_company_num']}}<i
                                        class="layui-inline layui-icon layui-icon-flag"></i></span>
                        </p>
                    </div>
                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function getJobOrderItemTrend(days_num) {
            ajaxRequest('{{URL::asset('/company/role0/overview/jobOrderItemTrend')}}', {"days_num": days_num}, "GET", function (ret) {
                    if (ret.result === true) {
