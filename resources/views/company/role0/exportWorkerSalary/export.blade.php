                        ...
                        <div class="layui-form" lay-filter="">
                                ...
                                <div class="layui-input-inline">
                                    <select name="bus_company_id" lay-verify="required">
                                        ...
                                        @foreach($bus_companys as $bus_company)
                                            <option value="{{$bus_company->id}}">{{$bus_company->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="layui-form-mid layui-word-aux">将导出项目下全部工作包的工资单</div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">导出时段</label>
                                <div class="layui-input-inline" style="width: 100px;">
                                    <input type="text" class="layui-input" id="from_date" name="from_date"
                                           lay-verify="required"
                                ...
                                <div class="layui-input-inline" style="width: 100px;">
                                    <input type="text" class="layui-input" id="to_date" name="to_date"
                                           lay-verify="required"
                                           placeholder="yyyy-MM-dd"
                                           value="">
                                </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit lay-filter="LAY-form-edit">进行导出</button>
    ...
    <script type="text/javascript">
        ...
        layui.use(['index', 'layer', 'form', 'set', 'laydate'], function () {
            ...
            form.on('submit(LAY-form-edit)', function (data) {
                ...
                //进行请求
                ajaxRequest('{{URL::asset('/company/role0/exportWorkerSalary/export')}}', param, "POST", function (ret) {
                    if (ret.result) {
