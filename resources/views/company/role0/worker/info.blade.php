                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <button class="layui-btn layui-btn-sm"
                                            onclick="job_order_worker_list('工作包接单-{{$data->name}}','{{URL::asset('/company/role0/jobOrderWorker/index')}}?worker_id={{$data->id}}',{{$data->id}})">
                                        接包信息
                                    </button>
                                    <button class="layui-btn layui-btn-sm"
                                            onclick="job_order_item_list('工作包任务-{{$data->name}}','{{URL::asset('/company/role0/jobOrderItem/index')}}?worker_id={{$data->id}}',{{$data->id}})">
                                        任务明细
                                    </button>
                                    <button class="layui-btn layui-btn-sm"
                                            onclick="worker_setUser('员工绑定-{{$data->name}}','{{URL::asset('/company/role0/worker/setUser')}}?id={{$data->id}}',{{$data->id}})">
                                        绑定用户
                                    </button>
...
@section('script')
    <script type="text/javascript">
         ...
         */
        function refresh() {
            {{--location.replace('{{URL::asset('/company/role0/city/index')}}');--}}
            reloadPage();
        }
