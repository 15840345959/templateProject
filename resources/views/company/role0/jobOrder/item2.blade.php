...
<script type="text/javascript">
    ...
    layui.use(['carousel', 'index', 'layer', 'form', 'set', 'laypage', 'laydate'], function () {
        ...
        form.on('submit(LAY-form-edit)', function (data) {
            ...
            //进行请求
            ajaxRequest('{{URL::asset('/company/role0/jobOrder/edit')}}', param, "POST", function (ret) {
                if (ret.result) {
                    layer.msg('保存成功', {icon: 1, time: 1000});
                    location.replace('{{URL::asset('/company/role0/jobOrder/edit')}}?item={{$item}}&id=' + ret.ret.id);
                } else {
