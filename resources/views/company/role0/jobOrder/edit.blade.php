                        ...
                        <div class="layui-tab layui-tab-brief" lay-filter="component-tabs-brief">
                            ...
                            <div class="layui-tab-content">
                                <div class="mt-10">
                                    {{--通过item控制显示选项--}}
                                    @if($item=='0')
                                        @include('company.role0.jobOrder.item0')
                                    @endif
                                    @if($item=='1')
                                        @include('company.role0.jobOrder.item1')
                                    @endif
                                    @if($item=='2')
                                        @include('company.role0.jobOrder.item2')
                                    @endif
                                </div>
                            </div>
                        </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function selectItem(item) {
            ...
            location.replace('{{URL::asset('/company/role0/jobOrder/edit')}}?id={{$data->id}}&item=' + item);
        }
