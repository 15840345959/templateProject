                    ...
                    <div class="layui-card-body">
                        <div style="padding-bottom: 10px;">
                            <button class="layui-btn layuiadmin-btn-forum-list"
                                    onclick="setWorker('指派公司雇员','{{URL::asset('company/role0/jobOrder/setWorker')}}?id={{$data->id}}')">
                                指派公司雇员
                            </button>
                                    ...
                                    <tr class="{{$job_order_worker->alert_level}}"
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                @endif
                                                <button class="layui-btn layui-btn-sm"
                                                        onclick="info('工作包接单详情-{{$data->id}}','{{URL::asset('company/role0/jobOrderWorker/info')}}?id={{$job_order_worker->id}}',{{$job_order_worker->id}})">
                                                    详情
                                                </button>
                                            </div>
                                        </td>
