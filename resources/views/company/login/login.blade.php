...
<head>
    ...
    {{--layui--}}
    <link rel="stylesheet" href="{{ asset('dist/static/layuiAdmin.std-v1.2.1/dist/layuiadmin/layui/css/layui.css') }}"
          media="all">
    <link rel="stylesheet" href="{{ asset('dist/static/layuiAdmin.std-v1.2.1/dist/layuiadmin/style/admin.css') }}"
          media="all">
    <link rel="stylesheet" href="{{ asset('dist/static/layuiAdmin.std-v1.2.1/dist/layuiadmin/style/login.css') }}"
          media="all">
    {{--引入自定义的公共common.css--}}
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main" style="background: white;">
        <div class="layadmin-user-login-box layadmin-user-login-header">
            <h2>{{env('APP_NAME','')}} | 物业后台</h2>
            <p>业务物业后台，如需登录平台请联系业务负责人</p>
        </div>
        <div action="" method="post" class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;">
                ...
                <a href="#" class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;"
                   onclick="forgetPassword();">忘记密码？</a>
            </div>
            <div class="layui-form-item">
...
<script src="{{ asset('dist/static/layuiAdmin.std-v1.2.1/dist/layuiadmin/layui/layui.js') }}"></script>
<!-- common -->
...
<script>
    ...
    layui.config({
        base: '{{ asset('dist/static/layuiAdmin.std-v1.2.1/dist/layuiadmin/') }}/' //静态资源所在路径
    }).extend({
    ...
    layui.use(['index', 'form', 'layer'], function () {
        ...
        form.on('submit(LAY-user-login-submit)', function (data) {
            ...
            //进行请求
            ajaxRequest('{{URL::asset('/company/login')}}', param, "POST", function (ret) {
                if (ret.result) {
                    layer.msg('登录成功');
                    //根据角色进行后台跳转
                    window.location.replace("{{URL::asset('/company/index')}}");      //后台主页
                } else {
