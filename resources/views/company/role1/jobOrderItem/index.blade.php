        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <form id="search_form" class="layui-form" method="post"
                      action="{{URL::asset('/company/role1/jobOrderItem/index')}}?page={{$datas->currentPage()}}">
                    {{csrf_field()}}
                                ...
                                <td>
                                    <div>
                                        ...
                                        <button class="layui-btn layui-btn-sm"
                                                onclick="info('工作任务详情-{{$data->id}}','{{URL::asset('company/role1/jobOrderItem/info')}}?id={{$data->id}}',{{$data->id}})">
                                            详情
                                        </button>
                                    </div>
                                </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function refresh() {
            $('#search_form')[0].reset();
            {{--location.replace('{{URL::asset('/company/role1/jobOrderItem/index')}}');--}}
            reloadPage();
        }
