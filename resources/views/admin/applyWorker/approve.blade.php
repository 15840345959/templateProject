                    ...
                    <div class="layui-card-body" pad15>
                        <div class="layui-form" lay-filter="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <span class="layui-form-mid">{{$data->birthday}}</span>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">年龄</label>
                                <div class="layui-input-inline">
                                    <span class="layui-form-mid">{{$data->age}}</span>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">工作</label>
                                <div class="layui-input-inline">
                                    <span class="layui-form-mid">{{isset($data->job)?$data->job->name:'--'}}</span>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit lay-filter="LAY-form-edit">审核通过</button>
    ...
    <script type="text/javascript">
        ...
        layui.use(['index', 'layer', 'form', 'set', 'laydate'], function () {
            ...
            form.on('select(role)', function (data) {
                ...
                //如果是临时店员，需要展示有效期的控件
                if (role == "1") {
                    $("#valid_end_time_div").removeClass("hidden");
                } else {
                    $("#valid_end_time_div").addClass("hidden");
                }
            });
            ...
            form.on('submit(LAY-form-edit)', function (data) {
                ...
                if (role == "1") {
                    ...
                    if (judgeIsAnyNullStr(valid_end_time)) {
                        layer.msg("临时店员需要设置有效期", {icon: 5, time: 1000});
                        return false;
                    }
                ...
                //进行请求
                ajaxRequest('{{URL::asset('/admin/applyWorker/approve')}}', param, "POST", function (ret) {
                    if (ret.result) {
