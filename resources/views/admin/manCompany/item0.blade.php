<div class="layui-form" lay-filter="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" value="{{$data->name}}" class="layui-input"
                   lay-verify="required" style="width: 650px"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="img" id="img" placeholder="图片地址"
                   value="{{$data->img}}" class="layui-input hidden">
            <div class="layui-upload">
                <div class="layui-upload-list">
                    <div id="container">
                        <img src="{{ isset($data->img) ? $data->img : URL::asset('/img/upload_rect.png') }}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux">
            <button class="layui-btn layui-btn-sm layui-btn-radius" onclick="getLocation()">地址解析
            </button>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <div class="layui-form-mid layui-word-aux" style="width: 650px;">
                输入地图地址解析，获取精确经纬度，用于地图导航，例如输入:沈阳市兴隆大奥莱，点击地址解析即可获取经纬度信息
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="text" id="lon" name="lon" value="{{$data->lon}}" placeholder=""
                       autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-form-mid">/</div>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="text" id="lat" name="lat" value="{{$data->lat}}" placeholder=""
                       autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 650px">
                <div id="amap_div" style="height: 400px;width: 100%;"></div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    layui.use(['carousel', 'index', 'layer', 'form'], function () {
        ...
        form.on('submit(LAY-form-edit)', function (data) {
            ...
            //进行请求
            ajaxRequest('{{URL::asset('/admin/manCompany/edit')}}', param, "POST", function (ret) {
                if (ret.result) {
                    layer.msg('保存成功', {icon: 1, time: 1000});
                    location.replace('{{URL::asset('/admin/manCompany/edit')}}?item={{$item}}&id=' + ret.ret.id);
                } else {
