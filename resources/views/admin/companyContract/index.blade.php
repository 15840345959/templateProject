        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <form id="search_form" class="layui-form" method="post"
                      action="{{URL::asset('admin/companyContract/index')}}?page={{$datas->currentPage()}}">
                    {{csrf_field()}}
                            ...
                            <tr class="{{$data->alert_level}}" title="{{$data->alert_str}}">
                                ...
                                <td>
                                    <div>
                                        ...
                                        @endif
                                        <button class="layui-btn layui-btn-sm"
                                                onclick="edit('编辑合同-{{$data->name}}','{{URL::asset('/admin/companyContract/edit')}}?id={{$data->id}}&man_company_id={{$data->man_company_id}}',{{$data->id}})">
                                            编辑
                                        </button>
                                        <button class="layui-btn layui-btn-sm"
