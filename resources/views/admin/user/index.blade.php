        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <form id="search_form" class="layui-form" method="post"
                      action="{{URL::asset('admin/user/index')}}?page={{$datas->currentPage()}}">
                    {{csrf_field()}}
                ...
                <div>
                    <table class="layui-table text-c" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th class="text-c" width="80">姓名</th>
                            <th class="text-c" width="40">积分</th>
                            <th class="text-c" width="100">注册时间</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        {{--onclick="info('行为记录','{{URL::asset('admin/user/info')}}?id={{$data->id}}',{{$data->id}})">--}}
                                        {{--行为记录--}}
                                        {{--</button>--}}
                                    </div>
                                </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function refresh() {
            $('#search_form')[0].reset();
            {{--location.replace('{{URL::asset('/admin/user/index')}}');--}}
            reloadPage();
        }
