        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <form id="search_form" class="layui-form" method="post"
                      action="{{URL::asset('admin/ad/index')}}?page={{$datas->currentPage()}}">
                    {{csrf_field()}}
            ...
            <div class="layui-card-body">
                <div style="padding-bottom: 10px;">
                    <button class="layui-btn layuiadmin-btn-forum-list"
                            onclick="edit('添加轮播图','{{URL::asset('admin/ad/edit')}}')">
                        添加轮播图
                    </button>
                </div>
                <div class="table-container">
                    <table class="layui-table text-c" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th class="text-c" width="40">图片</th>
                            <th class="text-c" width="60">标题</th>
                            <th class="text-c" width="20">顺序</th>
                            <th class="text-c" width="40">跳转类型</th>
                        ...
                        @foreach($datas as $data)
                            <tr>
                                <td>{{$data->id}}</td>
                                <td>
                                    <img src="{{ $data->img ? $data->img : Url::asset('/img/upload.png')}}"
                                         class="img-pic">
                                </td>
                                <td>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <button class="layui-btn layui-btn-sm"
                                                onclick="edit('编辑轮播图','{{URL::asset('admin/ad/edit')}}?id={{$data->id}}',{{$data->id}})">
                                            编辑
                                        </button>
                                    </div>
                                </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function refresh() {
            $('#search_form')[0].reset();
            {{--location.replace('{{URL::asset('/admin/ad/index')}}');--}}
            reloadPage();
        }
