                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="type" lay-verify="required">
                                        @foreach(\App\Components\Project::AD_TYPE_VAL as $key=>$value)
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <div class="layui-upload">
                                        <div class="layui-upload-list">
                                            <div id="container">
                                                <img src="{{ isset($data->img) ? $data->img : URL::asset('/img/upload.png') }}"
    ...
    <script type="text/javascript">
        ...
        layui.use(['index', 'layer', 'form', 'set'], function () {
            ...
            form.on('submit(LAY-form-edit)', function (data) {
                ...
                //进行请求
                ajaxRequest('{{URL::asset('/admin/ad/edit')}}', param, "POST", function (ret) {
                    if (ret.result) {
