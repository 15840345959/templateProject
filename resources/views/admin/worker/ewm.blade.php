        ...
        <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body">
                        <ul class="layuiadmin-card-status layuiadmin-home2-usernote">
                            ...
                            <li>
                                <h3>本项目中如何应用工卡</h3>
                                <p>
                                    本项目中生成的工卡，更加具有实际意义。根据前期的调研和沟通，本项目为众包平台，需要员工在手机端完成工作打卡、工作汇报等操作。为了方便员工使用小程序，针对导入的员工，可以通过扫码工卡中的二维码，完成小程序账号的绑定，只要您将工卡转发给相应的员工，员工通过扫描工卡二维码的方式，即可绑定账号。绑定账号后，在小程序中可以进行工作打卡、工作汇报，其功能与Web版一致，从而解决了可能存在的终端不足、网络环境不具备的问题，进而也提升了运营了灵活性，助力业务发展。</p>
                            </li>
                            <li>
            ...
            <div class="layui-col-md4">
                <div class="layui-card">
                    <div class="layui-card-header">
                        样式预览
                        <a href="{{URL::asset('/img/workerCard/'.$filename)}}" target="_blank"
                           class="layui-a-tips">下载</a>
                    </div>
                    <div class="layui-card-body">
                        <div style="text-align: center;">
                            <img src="{{URL::asset('/img/workerCard/'.$filename)}}" style="width: 90%;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function unbindWX(obj, id) {
            ...
            layer.confirm('确认要解绑微信？', function (index) {
                ...
                ajaxRequest('{{URL::asset('')}}' + "admin/worker/unbindWX/" + id, param, "GET", function (ret) {
                    if (ret.result == true) {
