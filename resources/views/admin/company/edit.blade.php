                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <div class="layui-form-mid layui-word-aux" style="width: 650px;">
                                        公司官网可以为空，官网建设2000元，包设计、域名申请、空间租赁，免费维护一年
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="email" value="{{$data->email}}" lay-verify="email"
                                           ...
                                           class="layui-input" placeholder="请输入公司邮箱">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">二维码</label>
                                <div class="layui-input-inline">
                                    <input name="ewm_img" id="ewm_img" placeholder="图片地址"
                                           value="{{$data->ewm_img}}" class="layui-input hidden">
                                    <div class="layui-upload">
                                        <div class="layui-upload-list">
                                            <div id="container">
                                                <img src="{{ isset($data->ewm_img) ? $data->ewm_img : URL::asset('/img/upload_rect.png') }}"
    ...
    <script type="text/javascript">
        ...
        layui.use(['index', 'layer', 'form', 'set'], function () {
            ...
            form.on('submit(LAY-form-edit)', function (data) {
                ...
                //进行请求
                ajaxRequest('{{URL::asset('/admin/company/edit')}}', param, "POST", function (ret) {
                    if (ret.result) {
