        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <form id="search_form" class="layui-form" method="post"
                      action="{{URL::asset('/admin/busCompany/index')}}?page={{$datas->currentPage()}}">
                    {{csrf_field()}}
                                ...
                                <td>
                                    <div>
                                        ...
                                        <button class="layui-btn layui-btn-sm"
                                                onclick="edit('编辑在管项目-{{$data->name}}','{{URL::asset('/admin/busCompany/edit')}}?id={{$data->id}}&man_company_id={{$data->man_company_id}}',{{$data->id}})">
                                            编辑
                                        </button>
                                        <button class="layui-btn layui-btn-sm"
                                                onclick="edit_worker('人员管理-{{$data->name}}','{{URL::asset('/admin/busCompany/worker')}}?id={{$data->id}}',{{$data->id}})">
                                            人员
                                        </button>
                                    </div>
                                </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function refresh() {
            $('#search_form')[0].reset();
            {{--location.replace('{{URL::asset('/admin/busCompany/index')}}');--}}
            reloadPage();
        }
