                    ...
                    <div class="layui-card-body" pad15>
                        <div class="layui-form" lay-filter="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <span class="layui-form-mid">{{$job->name}}</span>
                                </div>
                            </div>
                            <div class="layui-form-item hidden">
                                <label class="layui-form-label">工作id</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="job_id" value="{{$job->id}}" class="layui-input"
                                           lay-verify="required"
                                           placeholder="工作id">
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['index', 'layer', 'form', 'set'], function () {
            ...
            form.on('submit(LAY-form-edit)', function (data) {
                ...
                //进行请求
                ajaxRequest('{{URL::asset('/admin/subJob/edit')}}', param, "POST", function (ret) {
                    if (ret.result) {
